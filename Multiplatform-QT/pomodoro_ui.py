...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.label_hours = QtGui.QLabel(self.tab)
        ...
        self.label_minutes = QtGui.QLabel(self.tab)
        ...
        self.label_seconds = QtGui.QLabel(self.tab)
    ...
    def retranslateUi(self, main_window):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("main_window", "Countdown", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("main_window", "Pomodoro", None))
